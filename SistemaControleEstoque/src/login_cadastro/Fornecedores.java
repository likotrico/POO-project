...
public class Fornecedores extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Fornecedores2
     */
    public Fornecedores() {
        initComponents();
    }
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {
        DefaultTableModel dtmFornecedores = (DefaultTableModel) tableFornecedores.getModel();
        if (txtNome.getText().trim().equals("") || txtEmail.getText().trim().equals("") || txtTelefone.getText().trim().equals("") || txtProduto.getText().trim().equals("")) {
            ...
            if (txtEmail.getText().contains("@") && txtEmail.getText().contains(".com")) {
                if (verificarTelefone()) {
                    ...
                    if (fornecedorExistente(txtEmail.getText())) {
                        Object[] dados = {txtNome.getText(), txtEmail.getText(), txtTelefone.getText(), txtProduto.getText()};
                        dtmFornecedores.addRow(dados);
                        cadastrar();
                    }
                    else {
                        JOptionPane.showMessageDialog(null, "Este fornecedor já existe", null, JOptionPane.ERROR_MESSAGE);
                    }
                }
            }
            else {
    ...
    private void cadastrar() {
        Externo fornecedor = new Externo();
        fornecedor.setNome(txtNome.getText()); 
        fornecedor.setEmail(txtEmail.getText());
        fornecedor.setTelefone(txtTelefone.getText());
        fornecedor.setCodProduto(txtProduto.getText());
        fornecedor.setTipoExterno(TipoExterno.FORNECEDOR);
        
        try {
            FileWriter fw = new FileWriter("SistemaControleEstoque/src/db/fornecedor.csv", true); //criado dentro do projeto, porém da para passar o diretório onde queremos criar
            PrintWriter pw = new PrintWriter(fw);
            pw.print(fornecedor.getNome()+";");
            pw.print(fornecedor.getEmail()+";");
            pw.print(fornecedor.getTelefone()+";");
            pw.println(fornecedor.getCodProduto()+";");
    ...
    private boolean fornecedorExistente(String email) {
        String file = "SistemaControleEstoque/src/db/fornecedor.csv";
    ...
    private boolean verificarProduto() {
        ...
        String caminhoArquivo = "SistemaControleEstoque/src/db/fornecedor.csv"; // Caminho do arquivo CSV
        String stringParaRemover = JOptionPane.showInputDialog(null, "Digite o email do fornecedor:");
        
        if (fornecedorExistente(stringParaRemover) == false) {
            ...
            DefaultTableModel dtmForncedores = (DefaultTableModel) tableFornecedores.getModel();
            dtmForncedores.setRowCount(0);
            carregarFornecedor();
            JOptionPane.showMessageDialog(null, "Fornecedor removido com sucesso", null, JOptionPane.INFORMATION_MESSAGE);
        }
