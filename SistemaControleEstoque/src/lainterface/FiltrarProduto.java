...
public class FiltrarProduto extends javax.swing.JFrame {
    ...
    private void filtrar(int codigo, Estoque estoque) {
        ...
        for (Informacoes informacoes : array) {
            ...
            Object[] dados = {informacoes.getProduto(), informacoes.getProdutoDia(), informacoes.getProdutoMes(), informacoes.getProdutoAno(), informacoes.getPredio(), informacoes.getLado(), informacoes.getNivel()};
